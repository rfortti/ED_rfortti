...
class ListaDeNosApp
   ...
   public static void main(String[] args)
      ...
      theList.insertFirst("João", "Paula Fernandes", 25);      // inserimos quatro itens nela
      theList.insertFirst("José", "Bruna Marq.", 18);
      theList.insertFirst("Manoel", "Andressa", 21);
      theList.insertFirst("Rovanildo", "Isis", 22);
